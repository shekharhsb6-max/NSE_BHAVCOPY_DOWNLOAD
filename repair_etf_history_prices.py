...
def main():
    ws = connect()
    # Read only the 9 ETF_HISTORY columns used by this repair.
    # The worksheet may physically contain additional blank/helper columns,
    # which get_all_values() would include and break the 9-column DataFrame.
    values = ws.get("A:I")
